...
(function() {
  ...
  BookDetailController = (function() {
    ...
    function BookDetailController($scope, $stateParams, Books, $window, $ionicModal, Comments, DoubanService, $ionicActionSheet) {
      ...
      this.closeShare = __bind(this.closeShare, this);
      ...
      this.$scope.closeShare = this.closeShare;
      ...
      this.$ionicModal.fromTemplateUrl('templates/modal/share.html', (function(_this) {
        return function(modal) {
          return _this.$scope.shareModal = modal;
        };
      })(this), {
        scope: this.$scope,
        animation: 'slide-in-up'
    ...
    BookDetailController.prototype.goShare = function() {
      return this.$scope.shareModal.show();
    };

    BookDetailController.prototype.closeShare = function() {
      return this.$scope.shareModal.hide();
    };

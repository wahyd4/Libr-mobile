...
(function() {
  ...
  SwipeBack = (function() {
    SwipeBack.$inject = ['$ionicGesture', '$window'];

    function SwipeBack($ionicGesture, $window) {
      ...
      return {
        ...
        link: (function(_this) {
          return function(scope, element, attribute) {
            return _this.$ionicGesture.on('swiperight', function(event) {
              return _this.$window.history.back();
            }, element);
          };
        })(this)
      };
...
(function() {
  ...
  BookDetailController = (function() {
    BookDetailController.$inject = ['$scope', '$stateParams', 'Books', '$window', '$ionicModal', 'Comments', 'DoubanService', '$ionicActionSheet'];

    function BookDetailController($scope, $stateParams, Books, $window, $ionicModal, Comments, DoubanService, $ionicActionSheet) {
      this.$scope = $scope;
      ...
      this.swipeRight = __bind(this.swipeRight, this);
      ...
      this.$scope.goShare = this.goShare;
      this.$scope.swipeRight = this.swipeRight;
    ...
    BookDetailController.prototype.goShare = function() {
      return window.plugins.socialsharing.share('我刚通过Libr发现了好书《' + this.$scope.book.name + '》，推荐你也来看看。' + ' https://itunes.apple.com/cn/app/libr/id865672150?l=zh&ls=1&mt=8', null, this.$scope.book.image_large, 'http://librme.com');
    };

    BookDetailController.prototype.swipeRight = function() {
      return this.$window.history.back();
    };
      ...
      return this.Books.fetchNew({
        ...
        return function(data) {
          ...
          if (data.books.length !== 0) {
            ...
            return localStorage.setItem('user_has_books', false);
          }
        };
      })(this));
    };
    ...
    BooksController.prototype.submitDoubanUser = function() {
      ...
      return this.DoubanService.submitUser(username, (function(_this) {
        return function(data) {
          ...
          _this.$scope.doubanUsername = username;
          _this.$scope.submitAllowed = false;
...
(function() {
  ...
  HomeController = (function() {
    ...
    HomeController.prototype.changeRecommend = function(index) {
      var hasBooks, msg, noBooksSubmitMsg;
      ...
      return this.RecommendService.changeRecommendAction(index, (function(_this) {
        return function(result) {
          var listArray;
          console.log('user books ===', hasBooks, hasBooks === null);
          if (result.length === 0 && hasBooks) {
            return navigator.notification.alert(msg, null, 'Libr', '确定');
          } else if (result.length === 0 && !hasBooks) {
            return navigator.notification.alert(noBooksSubmitMsg, null, 'Libr', '确定');
          } else {
            _this.$scope.books = result;
            localStorage.setItem('home.books', JSON.stringify(result));
            ...
            return _this.$scope.title.name = listArray[index].text;
          }
        };
      })(this), (function(_this) {
        return function(error) {

...
(function(){var LocalStorageUtils,libr,__bind=function(fn,me){return function(){return fn.apply(me,arguments)}};libr=angular.module("libr.services.localstorage",[]),LocalStorageUtils=function(){function LocalStorageUtils(){this.getUserId=__bind(this.getUserId,this),user=JSON.parse(localStorage.getItem("user"))}var user;return user=null,LocalStorageUtils.prototype.getUserId=function(){return user.id},LocalStorageUtils}(),libr.service("LocalStorageUtils",LocalStorageUtils)}).call(this);
